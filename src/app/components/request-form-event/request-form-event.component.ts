...
@Component({
  selector: 'app-request-form-event',
  templateUrl: './request-form-event.component.html',
  styleUrls: ['./request-form-event.component.css'],
  imports: [TabulatorTableSingleComponent, FormsModule, NgbDatepickerModule],
})
export class RequestFormEventComponent {
